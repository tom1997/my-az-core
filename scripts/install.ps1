...
Set-ConfigValue $playerbots 'AiPlayerbot.PvPTactical.DecisionInterval' ([string](Get-SettingValue $settings 'pvpTacticalDecisionInterval' 900))
...
Set-ConfigValue $playerbots 'AiPlayerbot.PvPTactical.Hunter.PreferredDistance' ([string](Get-SettingValue $settings 'pvpTacticalHunterPreferredDistance' 32.0))
Set-ConfigValue $playerbots 'AiPlayerbot.PvPTactical.Caster.PreferredDistance' ([string](Get-SettingValue $settings 'pvpTacticalCasterPreferredDistance' 26.0))
Set-ConfigValue $playerbots 'AiPlayerbot.PvPTactical.Healer.PreferredDistance' ([string](Get-SettingValue $settings 'pvpTacticalHealerPreferredDistance' 30.0))
...
Set-ConfigValue $playerbots 'AiPlayerbot.PvPTactical.Melee.DecisionInterval' ([string](Get-SettingValue $settings 'pvpTacticalMeleeDecisionInterval' 900))
